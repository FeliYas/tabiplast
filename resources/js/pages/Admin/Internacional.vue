...
// Initialize the form with internacional data
const form = useForm({
    titulo: props.internacional.titulo || '',
    descripcion: props.internacional.descripcion || '',
    path: null, // This will hold the main image file object
    banner: null // This will hold the banner file object
});

// Set initial image and banner preview
onMounted(() => {
    imagePreview.value = props.internacional.path;
    bannerPreview.value = props.internacional.banner;
});
...
const submit = () => {
    form.post(route('internacional.update', props.internacional.id), {
        preserveScroll: true,
        onSuccess: (page) => {
                ...
                <div
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="md:w-1/3 flex flex-col">
                            ...
                            <div
                                ...
                                <img :src="imagePreview" alt="Imagen"
                                    class="w-full h-80 object-cover rounded-md transition-all duration-500">
                        ...
                        <div class="md:w-1/3 flex flex-col">
                            ...
                            <input type="file" class="hidden" id="banner1" @change="previewBanner" accept="image/*">
                        </div>

                        <!-- Contenedor de formulario -->
                        <div class="flex flex-col justify-between w-full md:w-1/3 text-black">
                            ...
                            <div class="mb-6.5 mt-4">
                                <button type="submit" class="btn-primary w-full flex items-center justify-center"
                                    ...
                                    {{ form.processing ? 'Actualizando...' : 'Actualizar internacional' }}
                                </button>
                            </div>
                        </div>
                    </div>
